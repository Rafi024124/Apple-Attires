...
export default function Page() {
  const [form, setForm] = useState({
    ...
    mainCategory: "",
    subCategory: "",
    models: [], // Array of selected model values
    type: "",
    gender: "Unisex",
    images: [],
    description: "",
  ...
  // React Select multi-select handler for models
  ...
  // Get selected options in format {value,label} for react-select based on current form.models array
