...
export default function CartDrawer({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* Drawer */}
      <div
        className={`absolute top-0 right-0 h-full w-80 bg-white text-black shadow-lg transition-transform duration-300 ${
          open ? 'translate-x-0' : 'translate-x-full'
        }`}
        onClick={(e) => e.stopPropagation()} // prevent overlay click when clicking drawer
        aria-hidden={!open}
      >
